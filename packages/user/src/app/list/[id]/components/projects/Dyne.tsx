    ...
    return (
        <div className={'mx-auto max-w-[800px] pt-48'}>
            <BriefSection
                data={data}
                introduction={
                    '의료기기 스타트업 다인메디컬그룹의 웹사이트 리뉴얼의 디렉터를 맡았습니다. 소비자가 공감할 수 있는 내용을 바탕으로 UX라이팅을 진행하는 한편, 브랜드 감성에 맞는 영상과 사진을 기획했습니다.'
                }
                roles={
                    '1. UX라이팅을 통한 브랜드 경험 구축\n' +
                    '2. 기업 철학과 스토리를 개발 및 웹 사이트에 적용\n' +
            ...
            >
                ...
                <div className={PROJECT_CLASS_NAMES.SMALL_SECTION_WRAPPER}>
                    <SmallSection
                        title={'제품 철학'}
                        description={
                            '제품을 이해하기 위해 직접 현장에 방문하여 사내의 프로덕트 오너, 연구원 등 각 분야 담당자분들의 이야기를 들었습니다. 이를 바탕으로 제품의 철학을 정의하고 웹 사이트에 녹여냈습니다.'
                        }
                    />
                    <Image
                        src={Image2}
