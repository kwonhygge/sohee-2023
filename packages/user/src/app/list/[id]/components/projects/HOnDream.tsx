    ...
    return (
        <div className={'mx-auto max-w-[800px] pt-32 lg:pt-48'}>
            <BriefSection
                data={data}
                introduction={
                    '현대자동차와 정몽구 재단이 지원하는 ‘현대 2022 H온드림 마케팅 캠페인’ PM을 맡았습니다. 소재별 크리에이티브 전략을 통해 목표 이상의 성과를 달성했습니다.'
                }
                roles={
                    '1. 20인 이상 프로젝트의 PM으로 내부 인원 10인 리드\n' +
                    '2. 스타트업 2,743팀 지원 (목표 대비 150%)\n 3. 공식 홈페이지 누적 방문자수 51,147명 (전년 동기간 대비 234% 증가)\n' +
                    '4. 온드 미디어 관리를 통한 콘텐츠 발행 및 이벤트 안내 (IG/FB)- 10개월간 총 92개의 오리지널 콘텐츠 발행\n' +
                    '5. 온오프믹스, 이벤터스 등 플랫폼 메인 배너 광고 집행 및 각각의 효율 비교'
                }
            />
            <section
                className={
