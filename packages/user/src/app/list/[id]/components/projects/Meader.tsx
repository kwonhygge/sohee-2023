    ...
    return (
        <div className={'mx-auto max-w-[800px] pt-48'}>
            <BriefSection
                data={data}
                introduction={
                    '미더는 다양한 비영리단체와 사회적기업, 스타트업들의 이야기를 발굴하고 전문적인 마케팅 서비스를 제공하는 광고 에이전시입니다. 미더의 브랜딩팀 팀리더로서 내부 인터벌 브랜딩을 맡아 진행했습니다. 워크숍, 채용설명회 등 기업 행사를 주최하며 구성원에게 브랜드 가치를 내재화하고 잠재고객을 확보했습니다.'
                }
                roles={
                    '1. 각 분기별 임직원 대상 워크숍 기획 및 진행 \n' +
                    '2. 사내 인재상 정의 및 내부 평가 지표 활용\n' +
                    '3. 브랜드 철학 및 아이덴티티 통합 \n' +
                    '4. 임직원의 니즈에 따라 브랜드 컬러 리뉴얼 - 로고, 명함 등에 적용\n' +
                    '5. 채용설명회, 마케팅 강연 등 브랜드 행사 주최'
                }
            />
            <section
                className={
            ...
            >
                ...
                <div className={PROJECT_CLASS_NAMES.SMALL_SECTION_WRAPPER}>
                    <SmallSection
                        title={'브랜드 철학'}
                        description={
                            '전체 타운홀 미팅을 통해 브랜드 철학을 정의했습니다. 함께 만든 가치를 임직원 스스로 브랜드 가치를 내재화할 수 있도록 했습니다. 또한 외부 고객에게 브랜드 가치를 알리는데 활용했습니다.'
                        }
                    />
                    <Image
                        src={Image2}
