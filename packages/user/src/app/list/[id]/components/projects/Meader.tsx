    ...
    return (
        <div className={'mx-auto max-w-[800px] pt-32 lg:pt-48'}>
            <BriefSection
                data={data}
                introduction={
                    '미더는 다양한 비영리단체와 사회적기업, 스타트업들의 이야기를 발굴하고 전문적인 마케팅 서비스를 제공하는 광고 에이전시입니다. 미더의 브랜딩팀 팀리더로서 내부 인터널 브랜딩을 맡아 진행했습니다. 워크숍, 채용설명회 등 기업 행사를 주최하며 구성원에게 기업 가치를 내재화하고 잠재고객을 확보했습니다.'
                }
                roles={
            ...
            >
                ...
                <div className={PROJECT_CLASS_NAMES.SMALL_SECTION_WRAPPER}>
                    <SmallSection
                        title={'기업 철학'}
                        description={
                            '전체 타운홀 미팅을 통해 구성원의 의견을 모으고 기업 철학으로 정의했습니다. 이 과정에서 임직원 스스로 브랜드 가치를 내재화할 수 있도록 했습니다. 또한 외부 고객에게 브랜드 가치를 알리는데 활용했습니다.'
                        }
                    />
                    <Image
                        src={Image2}
