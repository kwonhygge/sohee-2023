            ...
            >
                ...
                <div className={PROJECT_CLASS_NAMES.SMALL_SECTION_WRAPPER}>
                    <SmallSection
                        title={'콜라보 전시'}
                        description={
                            '캐릭터에 관심이 많은 어린이, 일러스트를 좋아하는 20대를 대상으로 한 체험 전시 기획에 참여했습니다. 일러스트레이터 애슝 작가님과의 콜라보로 진행되었고 SNS와 자사 사이트를 통해 홍보를 진행했습니다. 그 결과, 일일 방문객 수 최초 3500명을 달성했습니다.'
                        }
                    />
                    <div>
                        <Image
